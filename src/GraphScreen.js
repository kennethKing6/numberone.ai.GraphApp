...
export default function GraphScreen() {
  ...
  function determineOverlayVisibility() {
    ...
    if (bleSupport.hasDevice() === true || connected === true) return false;
    return true;
  }
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={{ flex: 2, width: '100%' }}>
        <Text style={{
          fontSize: 20, width: '100%', padding: 5, backgroundColor: '#0C154A', color: 'white', textAlign: 'center',
        }}
        >
          Graph of Device RSSI (y-axis) over time/seconds (x-axis)
        </Text>
